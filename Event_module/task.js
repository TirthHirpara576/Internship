// Lec-17 :- Challenge: "Event Maestro: Handle It All!"
...
emitter.on("user-login", (username) => {
  eventCounts.user_login++;
  console.log(`${username} logged in!`);
});

emitter.on("user-purchase", (username, item) => {
  eventCounts.user_purchase++;
...
// Emit/Trigger/Call some events :-
emitter.emit("user-login", "Tirth Hirpara");
emitter.emit("user-purchase", "Tirth Hirpara", "Laptop");
// emitter.emit("profile-update", "Tirth Hirpara", "email");
emitter.emit("user-logout", "Tirth Hirpara");
