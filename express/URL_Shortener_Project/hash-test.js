// Lec-78 :- Which is the best password hashing algorithm? Bcryptjs vs Argon2 (To Run this file -> $node hash-test.js)
...
console.log("1 - 1", await verifyPassword(password1, hashedPassword1)); // same
console.log("2 - 1", await verifyPassword(password2, hashedPassword1)); // different
console.log("2 - 2", await verifyPassword(password2, hashedPassword2)); // same
console.log("1 - 2", await verifyPassword(password1, hashedPassword2)); // different